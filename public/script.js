...
let diamondDisplay, coinDisplay;
...
async function init() {
    ...
    buyDiamondsBtn = document.getElementById('buy-diamonds-btn');
    ...
    // Economy Display
    diamondDisplay = document.getElementById('diamond-count');
    ...
    if (buyDiamondsBtn) buyDiamondsBtn.addEventListener('click', buyDiamondsMock);

    // Header Economy Click
    document.getElementById('diamond-display').addEventListener('click', () => openModal(shopModal));
    document.getElementById('coin-display').addEventListener('click', () => openModal(shopModal));
    ...
    // Razorpay Logic (assuming script is loaded)
    async function buyDiamondsMock() {
        ...
        try {
            ...
            const options = {
                "key": "rzp_test_placeholder", // Replace with your Public ID or get from server if needed (safe to expose key_id)
                "amount": orderData.amount,
                "currency": orderData.currency,
                "name": "Ome Chat",
                "description": "100 Diamonds Pack",
                "image": "https://example.com/logo.png", // specific logo if you have one
                ...
                "prefill": {
                    ...
                    "contact": "9999999999" // Mock or get from user
                },
                "theme": {
                    "color": "#3399cc"
                }

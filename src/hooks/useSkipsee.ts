...
export function useSkipsee() {
    ...
    const lastSettingsRef = useRef<{ gender: string, interests: string[], country: string } | null>(null);
        ...
        const handleMatchFound = async (data: any) => {
            ...
            if (data.initiator) {
                ...
                try {
                    ...
                    s.emit('offer', { target: data.partnerId, sdp: offer });
                } catch (e) {
        ...
        const handleOffer = async (data: any) => {
            ...
            try {
                ...
                if (partnerIdRef.current) {
                    s.emit('answer', { target: partnerIdRef.current, sdp: answer });
                }

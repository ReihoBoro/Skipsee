...
export default function Home() {
  ...
  const settingsRef = useRef<{ gender: string, country: string, interests: string[] } | null>(null);

  const onStart = async (settings: { gender: string, interests: string[], country: string }) => {
